...
> {
  ...
  protected config = {
    ...
    defaultOrderBy: { id_ct_infraestructura_anexo: "asc" as const }, // Más recientes primero
    campoActivo: "estado",
  };
  ...
  protected nombreTablaParaBitacora = "ct_infraestructura_anexo"; // Nombre exacto de la tabla
